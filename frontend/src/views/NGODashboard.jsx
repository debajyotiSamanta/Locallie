    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 text-left">
      ...
      <div className="flex border-b border-zinc-200 dark:border-zinc-800 mb-8 space-x-4">
        <button
          ...
          className={`pb-3 text-xs font-bold flex items-center space-x-1.5 border-b-2 transition-all ${
            subTab === 'list' ? 'border-black text-black dark:text-white dark:border-white' : 'border-transparent text-zinc-550 hover:text-black dark:hover:text-zinc-200'
          }`}
        >
        ...
        {user.role === 'NGO/Volunteer' && (
          <button
            ...
            className={`pb-3 text-xs font-bold flex items-center space-x-1.5 border-b-2 transition-all ${
              subTab === 'create' ? 'border-black text-black dark:text-white dark:border-white' : 'border-transparent text-zinc-550 hover:text-black dark:hover:text-zinc-200'
            }`}
          >
      ...
      {loading ? (
        ...
        <div>
                ...
                drives.map(drive => (
                  <div key={drive.id} className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-lg overflow-hidden hover:shadow-sm transition-all duration-300 flex flex-col justify-between">
                    ...
                    <div className="p-6 text-left space-y-4">
                      ...
                      <div className="space-y-2 border-t border-zinc-150 dark:border-zinc-800 pt-4 text-xs text-zinc-500">
                      ...
                      <button
                        ...
                        className={`w-full py-2 rounded text-xs font-bold transition-all ${
                          drive.volunteers.includes(user.username)
                            ? 'bg-zinc-100 text-zinc-905 dark:bg-zinc-900 dark:text-zinc-205 border border-zinc-200 dark:border-zinc-800'
          ...
          {subTab === 'create' && (
            <div className="max-w-2xl bg-white dark:bg-zinc-955 border border-zinc-200 dark:border-zinc-800 rounded-lg p-6 md:p-8 shadow-sm">
              ...
              <form onSubmit={handleCreateDriveSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 border border-zinc-200 dark:border-zinc-805 bg-zinc-50 dark:bg-zinc-900 rounded text-xs outline-none focus:ring-1 focus:ring-black dark:focus:ring-white"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-zinc-200 dark:border-zinc-805 bg-zinc-50 dark:bg-zinc-900 rounded text-xs outline-none"
                    />
                  </div>
