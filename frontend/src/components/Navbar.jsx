...
import { Sun, Moon, MapPin, Award, LogOut, ShieldAlert, Users, Heart } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2.5 cursor-pointer" onClick={() => setActiveTab('landing')}>
            ...
            <span className="hidden sm:inline text-[10px] font-bold px-2 py-0.5 rounded bg-zinc-100 text-zinc-650 dark:bg-zinc-900 dark:text-zinc-450 border border-zinc-200/50 dark:border-zinc-800/50">
              AI Civic
            </span>
          </div>
            ...
            <button
              ...
              className={`px-4 py-2 text-xs font-semibold rounded-lg transition-all ${
                activeTab === 'landing'
                  ...
                  : 'text-zinc-600 hover:bg-zinc-50 hover:text-zinc-950 dark:text-zinc-450 dark:hover:bg-zinc-900/60 dark:hover:text-zinc-200'
              }`}
            >
              Home
            </button>
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="p-2 rounded-lg text-zinc-550 hover:bg-zinc-100 dark:text-zinc-450 dark:hover:bg-zinc-900 transition-all border border-zinc-200/60 dark:border-zinc-800/80"
              ...
              <div className="flex items-center space-x-3 bg-zinc-50 dark:bg-zinc-950 p-1.5 pr-3 rounded-lg border border-zinc-200 dark:border-zinc-900">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="hidden lg:block text-left text-[11px] leading-tight">
                    <div className="font-semibold text-zinc-855 dark:text-zinc-200 flex items-center space-x-1">
                      <span>{user.username}</span>
                      {getRoleIcon(user.role)}
                    </div>
                    <div className="flex items-center space-x-1.5 mt-0.5">
                      <span className="text-[9px] px-1 bg-zinc-200 text-zinc-800 dark:bg-zinc-800 dark:text-zinc-250 font-bold rounded">
                ...
                <button
                  onClick={logout}
                  className="p-1 text-zinc-455 hover:text-black dark:hover:text-white transition-all"
                  title="Logout"
                >
